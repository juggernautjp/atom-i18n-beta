...
## 3. Atom component to be localized
...
- [`atom-i18n`](https://github.com/liuderchi/atom-i18n): a package for internationalization (i18n), based on `japanese-menu`.
...
## 5. TODO: Remaining (not-localized)
...
| About View       | It is necessary to modify `atom/about` package (with React).   |
| Tree View        | <font color="Orange">TODO:</font> not localized AddDialog, CopyDialog and MoveDialog. |
