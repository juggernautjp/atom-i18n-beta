...
module.exports = class Util {
  static handleConfigChange() {
    atom.config.onDidChange('atom-i18n-beta.locale', ({ newValue: newLocale }) => {
    ...
    atom.config.onDidChange('atom-i18n-beta.customMenuI18nPath', () => {
  ...
  static findLaguageNameByLocale(locale) {
    const configEnum = atom.config.getSchema('atom-i18n-beta.locale').enum;
