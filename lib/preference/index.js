...
const PreferencesSettings = require('./settings');
...
module.exports = class Preferences {
  static delaySettings() {
    ...
    /* TODO: comment-out! in order to localize tab label, if Settings-view is not acitve.
    if (settingsTab) {
    ...
    */
    ...
    try {
      ...
      console.error(
        `I18N failed with locale ${atom.config.get('atom-i18n-beta.locale')}: `,
        e,
      );
    }
  }
